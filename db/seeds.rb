...
User.create([{name:'Israel Martinez',email:'marcemc@yahoo.com',password:'Password1'}, {name:'Jose Gonzalez',email:'jegsaiz@hotmail.com',password:'Wyncode2016'},{name:'Chanchis Munchis',email:'yesibanner@gmail.com',password:'Wyncode2015'},{name:'John Doe',email:'johndoe@email.com',password:'johndoerocks'},{name:'Monicus Villanus',email:'moverymartinez@yahoo.com',password:'maleficus'}])
